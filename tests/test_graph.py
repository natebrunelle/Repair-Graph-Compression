...
class GraphTestCase(unittest.TestCase):
    ...
    def test_graph_delete_edge(self):  # this now tests node things,
        ...
        # self.assertNotIn(self.n1, self.n2.edges) # this should also be true, not what testing here
    ...
    def test_graph_delete_node(self):
        ...
        self.assertIn(self.n2, self.g.list_nodes)
        self.assertNotIn(self.n1, self.g.n2.edges, "Found outside reference to deleted node")
        # n1 has no outside references in other nodes adj_lists

    def test_delete_node_delete_edge(self):  # Depreciated test?
